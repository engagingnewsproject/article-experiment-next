...
export function ResearchDashboardLogin({ onLogin }: ResearchDashboardLoginProps) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Research Dashboard</h2>
          <p className="text-gray-600">Access experimental data and analytics</p>
        </div>
      </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Research Access</span>
              </div>
            </div>
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-500">
                This dashboard contains experimental data for authorized researchers only.
                <br />
                Contact the research team for access credentials.
              </p>
            </div>
          </div>
        </div>
